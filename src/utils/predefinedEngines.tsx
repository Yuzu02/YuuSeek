...
export const predefinedEngines: SearchEngine[] = [
    ...
    },
    {
        ...
        icon: <BsBing className="h-5 w-5 text-[#258FFA]" />,
    ...
    },
    {
        ...
        icon: <SiDuckduckgo className="h-5 w-5 text-[#DE5833]" />,
    ...
    },
    {
        ...
        icon: <FaYahoo className="h-5 w-5 text-[#5F01D1]" />,
    ...
    },
    {
        ...
        icon: <SiEcosia className="h-5 w-5 text-[#2B9B2B]" />,
